...
import org.xtext.dsl.multimaven.web.MultiMavenWebSetup;
...
public class MultiMavenServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new MultiMavenWebSetup().createInjectorAndDoEMFRegistration();
