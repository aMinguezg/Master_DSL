...
public class InternalRestauranteLexer extends Lexer {
    ...
    public final void mRULE_FECHA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRestaurante.g:712:12: ( '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' )
            // InternalRestaurante.g:712:14: '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9'
            {
            matchRange('0','9'); 
            matchRange('0','9'); 
            match('-'); 
    ...
    public final void mRULE_URL() throws RecognitionException {
        try {
            int _type = RULE_URL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRestaurante.g:714:10: ( ( 'http' | 'https' ) '://' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '(' | ')' | '\\\\' | '/' | '.' | '0' .. '9' )+ )
            // InternalRestaurante.g:714:12: ( 'http' | 'https' ) '://' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '(' | ')' | '\\\\' | '/' | '.' | '0' .. '9' )+
            {
            // InternalRestaurante.g:714:12: ( 'http' | 'https' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalRestaurante.g:714:13: 'http'
                    {
                    match("http"); 
                    ...
                    break;
                case 2 :
                    // InternalRestaurante.g:714:20: 'https'
                    {
                    match("https"); 
            ...
            // InternalRestaurante.g:714:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '(' | ')' | '\\\\' | '/' | '.' | '0' .. '9' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRestaurante.g:716:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRestaurante.g:716:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalRestaurante.g:716:11: ( '^' )?
            int alt3=2;
            ...
            // InternalRestaurante.g:716:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRestaurante.g:718:10: ( ( '0' .. '9' )+ )
            // InternalRestaurante.g:718:12: ( '0' .. '9' )+
            {
            // InternalRestaurante.g:718:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalRestaurante.g:718:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRestaurante.g:720:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRestaurante.g:720:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRestaurante.g:720:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalRestaurante.g:720:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRestaurante.g:720:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalRestaurante.g:720:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRestaurante.g:720:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRestaurante.g:722:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalRestaurante.g:722:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalRestaurante.g:722:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRestaurante.g:724:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRestaurante.g:724:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalRestaurante.g:724:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
            ...
            // InternalRestaurante.g:724:40: ( ( '\\r' )? '\\n' )?
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalRestaurante.g:724:41: ( '\\r' )? '\\n'
                    {
                    // InternalRestaurante.g:724:41: ( '\\r' )?
                    int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRestaurante.g:726:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRestaurante.g:726:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRestaurante.g:726:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRestaurante.g:728:16: ( . )
            // InternalRestaurante.g:728:18: .
            {
            matchAny(); 
