...
import org.xtext.dsl.restaurante.web.RestauranteWebSetup;
...
public class RestauranteServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new RestauranteWebSetup().createInjectorAndDoEMFRegistration();
