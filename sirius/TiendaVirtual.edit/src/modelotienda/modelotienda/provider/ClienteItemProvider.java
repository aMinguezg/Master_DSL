...
/**
 * This is the item provider adapter for a {@link modelotienda.modelotienda.Cliente} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClienteItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelotiendaPackage.Literals.CLIENTE__NOMBRE,
				 true,
				 false,
				 false,
	...
	protected void addDireccionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cliente_direccion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cliente_direccion_feature", "_UI_Cliente_type"),
				 ModelotiendaPackage.Literals.CLIENTE__DIRECCION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Cliente.class)) {
			case ModelotiendaPackage.CLIENTE__NOMBRE:
			case ModelotiendaPackage.CLIENTE__DIRECCION:
