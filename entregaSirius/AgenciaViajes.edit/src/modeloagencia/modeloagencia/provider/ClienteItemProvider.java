...
/**
 * This is the item provider adapter for a {@link modeloagencia.modeloagencia.Cliente} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClienteItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDniPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cliente_Nombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cliente_Nombre_feature", "_UI_Cliente_type"),
				 ModeloagenciaPackage.Literals.CLIENTE__NOMBRE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Dni feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDniPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cliente_Dni_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cliente_Dni_feature", "_UI_Cliente_type"),
				 ModeloagenciaPackage.Literals.CLIENTE__DNI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEdadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cliente_Edad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cliente_Edad_feature", "_UI_Cliente_type"),
				 ModeloagenciaPackage.Literals.CLIENTE__EDAD,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModeloagenciaPackage.Literals.CLIENTE__TELEFONO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModeloagenciaPackage.Literals.CLIENTE__CLIENTE_TIENE_VIAJES);
		}
	...
	public String getText(Object object) {
		String label = ((Cliente)object).getNombre();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModeloagenciaPackage.Literals.CLIENTE__CLIENTE_TIENE_VIAJES,
